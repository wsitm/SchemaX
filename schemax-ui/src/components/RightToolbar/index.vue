<template>
  <div class="top-right-btn" :style="style" style="position: absolute; right: 0;">
    <el-row>
      <el-tooltip v-if="search" class="item" effect="dark"
                  :content="showSearch ? '隐藏搜索' : '显示搜索'"
                  placement="top">
        <el-button size="small" circle :icon="Search" @click="toggleSearch()"/>
      </el-tooltip>
      <el-tooltip class="item" effect="dark" content="刷新" placement="top">
        <el-button size="small" circle :icon="Refresh" @click="refresh()" style="margin-left: 5px;"/>
      </el-tooltip>
      <el-tooltip class="item" effect="dark" content="显隐列" placement="top" v-if="columns">
        <el-button v-if="showColumnsType == 'transfer'" size="small" circle :icon="Menu" @click="showColumn()"/>
