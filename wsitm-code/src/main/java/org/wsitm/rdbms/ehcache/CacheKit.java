package org.wsitm.rdbms.ehcache;
...
public class CacheKit {
    ...
    @SuppressWarnings("unchecked")
    public static <T> T get(String cacheName, Object key, Supplier<T> dataLoader) {
    ...
    @SuppressWarnings("unchecked")
    public static <T> T get(String cacheName, Object key, Class<? extends Supplier<T>> dataLoaderClass) {
        Object data = get(cacheName, key);
        if (data == null) {
            try {
                Supplier<T> dataLoader = dataLoaderClass.newInstance();
                data = dataLoader.get();
                put(cacheName, key, data);
            } catch (Exception e) {
